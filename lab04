...
def if_this_not_that(i_list, this):
    ...
    for num in i_list:
        if num > this:
            ...
            print('that')
if_this_not_that([1,2,3,4,5,6,7], 2)
...
def closer_city(lat, lon, city1, city2):
    ...
    if distance(tempcity, city1) > distance(tempcity, city2):
...
def replace_elem(lst, index, elem):
    ...
    "*** YOUR CODE HERE ***"
    return lst[:index] + [elem] + lst[(index + 1):] #没想出来

print(replace_elem([1,2,3,4,5,6,7], 2, 8))
